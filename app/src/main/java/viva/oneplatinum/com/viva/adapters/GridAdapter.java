...
public class GridAdapter extends ArrayAdapter<Friend> {
    static GridAdapter mGrid_Adapter;
    ...
    public GridAdapter(Context context, int textViewResourceId, ArrayList<Friend> list) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mFriend.isSelected){
            viewHolder.gridItemLayout.setBackgroundResource(R.color.grey);
        }else{
            viewHolder.gridItemLayout.setBackgroundResource(R.color.transparent);
        }
        ...
        viewHolder.gridItemLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                if(mFriend.invitation_status==1) {
                    if (!mFriend.isSelected) {
...
//                }
//            else{
//                    showToast(mFriend.invitation_status_msg);
//                }
            }
        });
        return view;
