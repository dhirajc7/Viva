 ...
 */
public class FinalUsingPreviosTemplateActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeslistAdapter = new ArrayAdapter<String>(FinalUsingPreviosTemplateActivity.this, android.R.layout.simple_list_item_1, PlaceArray);
        ...
        au_eventLocation.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
                ...
                try {
                    ...
                    AQuery aq = new AQuery(FinalUsingPreviosTemplateActivity.this);
...
//                        Log.d("list of places by address", PlaceArray.length + "");
                        placeslistAdapter = new ArrayAdapter<String>(FinalUsingPreviosTemplateActivity.this, android.R.layout.simple_list_item_1,
                                PlaceArray);
                        au_eventLocation.setAdapter(placeslistAdapter);
...
//                    }
    ...
    public Calendar showDateTimePickerStart(final TextView h) {
        // TODO Auto-generated method stub
        final AlertDialog.Builder builder = new AlertDialog.Builder(FinalUsingPreviosTemplateActivity.this);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (datePickerBoolean) {
                    ...
                    if (cL.after(c2)) {
                        new AlertDialog.Builder(FinalUsingPreviosTemplateActivity.this).setTitle("Confirmation")
    ...
    private void postEvent() {
        ...
        if (GeneralUtil.isNetworkAvailable(this)) {
            ...
            try {
                ...
                System.out.println(DataHolder.CREATE_EVENT + params.toString());
                ...
                if (result != null) {
                    try {
                        ...
                        if(finalstatus==1) {
                            ...
                            Intent i = new Intent(FinalUsingPreviosTemplateActivity.this, EventDetailActivity.class);
...
//        start_Date_Time.setText(mEventDetail.eventStartdate);
//        end_Date_Time.setText(mEventDetail.eventEnddate);
