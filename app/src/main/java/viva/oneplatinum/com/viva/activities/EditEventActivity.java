...
/**
 * Created by D-MAX on 4/4/2016.
 */
public class EditEventActivity extends ParentActivity implements ImageSelectorFromGallery,TypeSelectorListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aq = new AQuery(this);
        getAllMethod = EditEventActivity.this.getSharedPreferences(GETALLMETHOD, 0);
    ...
    eventType1.setOnClickListener(new View.OnClickListener() {
        ...
        eventType1.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        nextBtnToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validation()) {
                    ...
                    // postEvent();
                    Intent i = new Intent(EditEventActivity.this, FinalEditEventActivity.class);
...
//                    i.putExtra("type4", eventType4.getText());
                    ...
                    Log.e("circularImage", defaultImage + "");
                    Log.e("circularImage1", image1+"");
                    Log.e("circularImage2",image2+"");
                    Log.e("circularImage3", image3+"");
                    Log.e("circularImage4", image4+"");
                    startActivity(i);
                } else {
                    // do nothing
                }
...
//        }
                ...
                if (result != null) {
                    try {
                        ...
                        if (finalStatus == 1) {
                            ...
                            try {
                                JSONObject result1 = new JSONObject(eventDetailResult);
                                mEventDetail = ParseUtility.parseEventDetail(result1);
                                setData();
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
    ...
    public Calendar showDateTimePickerStart(final TextView h) {
        // TODO Auto-generated method stub
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(EditEventActivity.this);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (datePickerBoolean) {
                    ...
                    if (cL.after(c2)) {
                        new android.app.AlertDialog.Builder(EditEventActivity.this).setTitle("Confirmation")
...
//								+ ":" + eventStartMin);
    ...
    public void setData() {
        ...
        {
            Log.d("category1",mEventDetail.categoriesList.toString());
            if(i==0)
            {
                Log.d("category2",mEventDetail.categoriesList.toString());
                for(int k=0;k<mCategoryInfoList.size();k++){

                    Log.d("category3",mCategoryInfoList.toString());
                    if(mCategoryInfoList.get(k).category_id.equals(mEventDetail.categoriesList.get(0).categoryId)){
                        ...
                        for(int l=0;l<mCategoryInfoList.get(k).subCategoriesList.size();l++){
                            if(mCategoryInfoList.get(k).subCategoriesList.get(l).sub_category_id.equals(mEventDetail.categoriesList.get(0).subCategoryId)){
                                ...
                                Log.d("category4", "" + mCategoryInfoList.get(k).subCategoriesList.get(l).sub_category_name);
                                eventType1.setBackgroundResource(R.color.red);
                                eventType1.setTextColor(getResources().getColor(R.color.white));
                                eventType1.setSelected(true);
                            }
        ...
        for (int i = 0; i < mEventDetail.eventImages.size(); i++) {
            if (i == 0) {
                ...
                fontIconPlusSquareImg2.setText("f");
                image2=(mEventDetail.eventImages.get(2).trim());
            } else if (i == 3) {
                mAqueryTask.setImage(mEventDetail.eventImages.get(3).trim(), squareImage3, null);
                fontIconPlusSquareImg3.setText("f");
                image3=(mEventDetail.eventImages.get(3).trim());
            } else if (i == 4) {
                mAqueryTask.setImage(mEventDetail.eventImages.get(4).trim(), squareImage4, null);
                fontIconPlusSquareImg4.setText("f");
                image4=(mEventDetail.eventImages.get(4).trim());
            }
        }
    }
}
