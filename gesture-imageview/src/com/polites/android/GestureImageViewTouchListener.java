...
public class GestureImageViewTouchListener implements OnTouchListener {
	...
	public GestureImageViewTouchListener(final GestureImageView image,
		...
		zoomAnimation.setZoomAnimationListener(new ZoomAnimationListener() {
			...
			public void onComplete() {
				...
				Log.i("From zoom animation", "lastScale:" + lastScale
						+ "Starting scale : " + startingScale + "::" + isZoomed);
			}
		});
	...
	protected void handleScale(float scale, float x, float y) {
		...
		Log.i("GestureImageViewTouchListener", "Current zoom level:"
				+ currentScale + "Starting zoomscale:" + startingScale
				+ isZoomed);
	}
	...
	public boolean isZoomed() {
		// Log.e("GestureImageViewTouch", "Starting scale:" + startingScale +
		// ","
		// + "Last Scale: " + currentScale);
		// return currentScale != startingScale;
		return isZoomed;
	}

	public void setZoomAnimationListener(ZoomAnimationListener l) {
		this.zoomAnimation.setZoomAnimationListener(l);
	}
}
