...
public class LoginButton extends Button {
    ...
    public Session userInfoSession = null; // the Session used to fetch the current user info
    ...
    public OnClickListener listenerCallback;
    public boolean nuxChecked;
    public ToolTipPopup.Style nuxStyle = ToolTipPopup.Style.BLUE;
    public ToolTipMode nuxMode = ToolTipMode.DEFAULT;
    public long nuxDisplayTime = ToolTipPopup.DEFAULT_POPUP_DISPLAY_TIME;
    public ToolTipPopup nuxPopup;
